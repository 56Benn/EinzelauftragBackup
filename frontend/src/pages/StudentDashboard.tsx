...
import { getUsers, getSubjects, getClassMemberships, getClassMembershipsByStudent } from '@/lib/storage';
import { getGradeOptions, formatGrade, calculatePredictionPoints } from '@/lib/points';
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {userPrediction.prediction1 !== undefined && (
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-2">
                            ...
                            {userPoints1 !== undefined && (
                              <div className="flex items-center justify-between pt-1 border-t border-blue-200">
                                <span className="text-xs text-slate-600">Punkte:</span>
                                <span className="font-semibold text-green-600 text-xs">{userPoints1}</span>
                              </div>
                            )}
                          </div>
                        )}
                        {userPrediction.prediction2 !== undefined && (
                          <div className="bg-slate-50 border border-slate-200 rounded-lg p-2">
                            ...
                            {userPoints2 !== undefined && (
                              <div className="flex items-center justify-between pt-1 border-t border-slate-200">
                                <span className="text-xs text-slate-600">Punkte:</span>
                                <span className="font-semibold text-green-600 text-xs">{userPoints2}</span>
                              </div>
                            )}
                          </div>
                        )}
